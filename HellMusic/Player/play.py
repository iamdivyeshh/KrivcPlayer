...
async def play(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
                  [[
                      ...
                      InlineKeyboardButton("• Oᴡɴᴇʀ", url=f"https://t.me/zaynxop"),
                      InlineKeyboardButton("• Sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/HINDICHATINGGROUP"),
                  ],[
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton("💓 Oᴡɴᴇʀ", url=f"https://t.me/ZaYNxOP"),
                            InlineKeyboardButton("💭 Support", url=f"https://t.me/HINDICHATINGGROUP")
                        ],
                        [
                            InlineKeyboardButton("🗑 Close", callback_data="cls")
                        ]
